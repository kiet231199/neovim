local static = require('custom.plugin.winbar.utils.static')
local M = {}
...
M.opts = {
  ...
  bar = {
    ...
    sources = function(_, _)
      local sources = require('custom.plugin.winbar.sources')
      return {
        sources.path,
        {
  ...
  sources = {
    path = {
      ...
      relative_to = function(buf)
        return require('custom.plugin.winbar.utils.funcs.fs').proj_dir(
