...
if vim.fn.has("win32") == 1 then
	...
	global_config = {
		...
		-- Define path for python3 and nodejs framework
		python3_host_prog = "/data4/kietpham/00_dot/tools/python-3.10.7/bin/python3",
		node_host_prog = "/data4/kietpham/00_dot/tools/node-v16.17.1/lib/node_modules/neovim/bin/cli.js",
	}
end
